...
@SourceType(value = "OracleERPARP", label = "OracleERP",uiConfig = "oracleerp-layout.json")
public class OracleERPConf extends AbstractArpConf<OracleERPConf> {
  private static final String ARP_FILENAME = "arp/implementation/oracleerp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.oracleerp.OracleERPDriver";
